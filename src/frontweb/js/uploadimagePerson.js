function SWFImage(){
	...
	var setting = {
	            ...
	            button_image_url : "http://localhost:63342/Aa-Work/IMIKE/demo-fym/img/"+show_button,
	...
	function upload_start(selected, queued){
		...
		if( divBox=='huxing') strButtonType = '户型图';
		 ...
		 if( selected > upload_limit ){
			 alert("最多上传"+upload_limit+"张房源图片"/*+strButtonType*/);
			 for(i = 0; i< 10; i++){
				 this.cancelUpload();
			 }
			 return;
		 ...
		 if(already_upload_image_num < upload_limit){
			 ...
			 document.getElementById("upload_notice").innerHTML="最多上传"+upload_limit+"张房源图片"/*+strButtonType*/;
		 }
	}
